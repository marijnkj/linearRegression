...
Using the current seed, the lowest RMSE are produced by using the ridge-regression alternatives. The 10-fold-training did produce a slightly higher RMSE, but giving the small margin, this
